    ...
    <body>
        <center>
            <form action="" name="factura" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Agregar Factura</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Factura</td>
                            <td><input size="25" type="number" name="id_factura" id="id_factura" placeholder="Ingrese código" required></td>
                        </tr>
                        <tr>
                            <td>Cliente</td>
                            <td>
                            <select name="id_cliente" id="$obj->id_cliente" required>
