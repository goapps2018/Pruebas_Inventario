    ...
    <body>
        <center>
            <form action="" name="factura" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Modificar Factura</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Factura</td>
                            <td><input size="25" type="number" name="id_factura" id="id_factura" value="<?php echo $obj->id_factura ?>" placeholder="Ingrese código"></td>
                        </tr>
                        <tr>
                        <tr>
                            <td>Cliente</td>
