    ...
    <body>
        <center>
            <form action="" name="categoria" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Agregar Categoría</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Categoría</td>
                            <td><input size="36" type="number" name="id_categoria" id="id_categoria" placeholder="Ingrese código" required></td>
                        </tr>
                        <tr>
                            <td>Categoría</td>
