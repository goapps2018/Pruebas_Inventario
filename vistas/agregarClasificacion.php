    ...
    <body>
        <center>
            <form action="" name="clasificación" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Agregar Clasificación</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Clasificación</td>
                            <td><input size="30" type="number" name="id_clasificacion" id="id_clasificacion" placeholder="Ingrese código" required></td>
                        </tr>
                        <tr>
                            <td>Clasificación</td>
