    ...
    <body>
        <center>
            <form action="" name="cliente" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Agregar Cliente</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Cliente</td>
                            <td><input size="30" type="number" name="id_cliente" id="id_cliente" placeholder="Ingrese código" required></td>
                        </tr>
                        <tr>
                            <td>Tipo Documento</td>
                            <td>
                            <select name="id_tipo_documento" id="$obj->id_tipo_documento" required>
                                    <option>[Seleccione el tipo de documento]
                                        <?php
                                            do{
