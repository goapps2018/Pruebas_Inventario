    ...
    <body>
        <center>
            <form action="" name="detalle" method="POST">
                <table border="1">
                    <tr>
                        <td colspan="2"><center><b>Agregar Detalle</b></center></td>
                    </tr>
                    <tr>
                        <td>Código Detalle</td>
                        <td><input size="45" type="number" name="id_detalle" id="id_detalle" placeholder="Ingrese código" required></td>
                    </tr>
                    <tr>
                        <td>Factura</td>
                        <td>
                            <select name="id_factura" id="$obj->id_factura" required>
                                    <option>[Seleccione la factura]
                                        <?php
                                            do{
                    ...
                    <tr>
                        <td>Producto</td>
                        <td>
                            <select name="id_producto" id="$obj->id_producto" required>
                                    <option>[Seleccione el producto]
                                        <?php
                                            do{
