    ...
    <body>
        <center>
            <form action="" name="producto" method="POST">
                <table border="1">
                    <tr>
                        <td colspan="2"><center><b>Agregar Producto</b></center></td>
                    </tr>
                    <tr>
                        <td>Código Producto</td>
                        <td><input size="50" type="number" name="id_producto" id="id_producto" placeholder="Ingrese código" required></td>
                    </tr>
                    <tr>
                        <td>Proveedor</td>
                        <td>
                            <select name="id_proveedor" id="$obj->id_proveedor" required>
                                    <option>[Seleccione el proveedor]
                                        <?php
                                            do{
                    ...
                    <tr>
                        <td>Clasificación</td>
                        <td>
                            <select name="id_clasificacion" id="$obj->id_clasificacion" required>
                                    <option>[Seleccione la clasificación]
                                        <?php
                                            do{
                    ...
                    <tr>
                        <td>Categoría</td>
                        <td>
                            <select name="id_categoria" id="$obj->id_categoria" required>
                                    <option>[Seleccione la categoría]
                                        <?php
                                            do{
