    ...
    <body>
        <center>
            <form action="" name="proveedor" method="POST">
                <table border="1">
                    <tr>
                        <td colspan="2"><center><b>Agregar Proveedor</b></center></td>
                    </tr>
                    <tr>
                        <td>Código Proveedor</td>
                        <td><input size="40" type="number" name="id_proveedor" id="id_proveedor" placeholder="Ingrese código" required></td>
                    </tr>
                    <tr>
