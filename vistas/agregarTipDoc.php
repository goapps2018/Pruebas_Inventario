    ...
    <body>
        <center>
            <form action="" name="tipo_documento" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Agregar Tipo Documento</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Tipo Documento</td>
                            <td><input size="40" type="number" name="id_tipo_documento" id="id_tipo_documento" placeholder="Ingrese código" required></td>
                        </tr>
                        <tr>
