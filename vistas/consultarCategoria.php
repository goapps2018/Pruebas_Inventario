...
<html lang="es">
    ...
    <body>
        <center>
            <br>   
            <h3 class="font-weight-normal"><b>Categoría</b></h3> 
            ...
            <table >
                 ...
                 <tr>
		                ...
		                <th><input style="font-size:12px" type="text" id="id_categoria" name="id_categoria" placeholder="Ingrese el código de la categoría a consultar" size="50" >
