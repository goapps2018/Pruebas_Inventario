...
<html lang="es">
    ...
    <body>
        <center>
          <br>   
            <h3 class="font-weight-normal"><b>Cliente</b></h3> 
            ...
            <table >
                 ...
                 <tr>
		                ...
		                <th><input style="font-size:12px" type="text" id="id_cliente" name="id_cliente"   placeholder="Ingrese el código del cliente a consultar" size="50" >
