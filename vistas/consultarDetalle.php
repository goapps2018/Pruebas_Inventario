...
<html lang="es">
    ...
    <body>
        <center>
            <br>   
                <h3 class="font-weight-normal"><b>Venta Detalle</b></h3>
                ...
                <table>
                    ...
                    <tr>
                        <th><label for="nombre">Buscar</label></th>
                            <th><input style="font-size:12px" type="text" id="id_detalle" name="id_detalle" placeholder="Ingrese el código de la venta a consultar" size="50" >
