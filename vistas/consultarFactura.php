...
<html lang="es">
    ...
    <body>
        <center>
          <br>   
            <h3 class="font-weight-normal"><b>Factura</b></h3> 
            ...
            <table >
                 ...
                 <tr>
		                ...
		                <th><input style="font-size:12px" type="text" id="id_factura" name="id_factura"   placeholder="Ingrese el código de la factura a consultar" size="50" >
