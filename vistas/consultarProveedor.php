...
<html lang="es">
    ...
    <body>
        <center>
            <br>   
                <h3 class="font-weight-normal"><b>Proveedor</b></h3>
                ...
                <table>
                    ...
                    <tr>
                        <th><label for="nombre">Buscar</label></th>
                            <th><input style="font-size:12px" type="text" id="nombre" name="nombre" placeholder="Ingrese el nombre del proveedor a consultar" size="50" >
