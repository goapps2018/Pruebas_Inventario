...
if(isset($_POST['consulta'])){
    ...
    $c = new conexion();
    $cone = $c->conectando();
    $sql = "select usuario.id_usuario,nivel.nombre_nivel,usuario.id_nivel,usuario.nombre_usuario,usuario.clave from usuario inner join nivel on usuario.id_nivel = nivel.id_nivel where id_usuario like '%$obj->id_usuario%'";
...
<html lang="es">
    ...
    <body>
        <center>
          <br>   
            <h3 class="font-weight-normal"><b>Usuario</b></h3> 
