    ...
    <body>
        <center>
            <form action="" name="Tipo_documento" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Modificar Cliente</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Ciente</td>
                            <td><input size="30" type="number" name="id_cliente" id="id_cliente" value="<?php echo $obj->id_cliente?>" placeholder="Ingrese código"></td>
                        </tr>
                        <tr>
                        <tr>
