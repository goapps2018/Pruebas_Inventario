    ...
    <body>
        <center>
            <form action="" name="detalle" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Modificar Detalle</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Detalle</td>
                            <td><input size="45" type="number" name="id_detalle" id="id_detalle" value="<?php echo $obj->id_detalle?>" placeholder="Ingrese código"></td>
                        </tr>
                        <tr>
                            <td>Factura</td>
                            <td>
