    ...
    <body>
        <center>
            <form action="" name="producto" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center><b>Modificar Producto</b></center></td>
                        </tr>
                        <tr>
                            <td>Código Producto</td>
                            <td><input size="20" type="text" name="id_producto" id="id_producto" value="<?php echo $obj->id_producto?>" placeholder="Ingrese código"></td>
                        </tr>
                        <tr>
                            <td>Proveedor</td>
                            <td> 
